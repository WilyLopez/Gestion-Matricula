...
const campos = reactive<Record<string, CampoValidacion>>({
    ...
    fechaNacimiento: {
        valor: "",
        reglas: { requerido: true, fecha: true },
        tocado: false,
        error: "",
    },
    direccion: {
        valor: "",
        reglas: { requerido: true, minLongitud: 5, maxLongitud: 255 },
        tocado: false,
        error: "",
    },
    telefono: {
...
watch(
    () => props.estudiante,
    (nuevoEstudiante) => {
        if (nuevoEstudiante && props.modoEdicion) {
            ...
            formulario.fechaNacimiento =
                nuevoEstudiante.fechaNacimiento.split("T")[0];
            formulario.direccion = nuevoEstudiante.direccion;
            formulario.telefono = nuevoEstudiante.telefono;

            campos.nombres.valor = nuevoEstudiante.nombres;
            campos.apellidos.valor = nuevoEstudiante.apellidos;
            campos.dni.valor = nuevoEstudiante.dni;
            campos.fechaNacimiento.valor =
                nuevoEstudiante.fechaNacimiento.split("T")[0];
            campos.direccion.valor = nuevoEstudiante.direccion;
            campos.telefono.valor = nuevoEstudiante.telefono;
        }
    },
    { immediate: true }
);
...
const actualizarCampo = (
    nombreCampo: keyof EstudianteFormulario,
    valor: string
) => {
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input
                    ...
                    :class="{
                        'is-invalid':
                            campos.direccion.tocado && campos.direccion.error,
                    }"
                    id="direccion"
                ...
                />
                <div
                    v-if="campos.direccion.tocado && campos.direccion.error"
                    class="invalid-feedback"
                >
